...
const AddComment = (props) => {
  ...
  const getStarsList = () => {
    ...
    return Object.keys(Stars).sort((a, b) => b - a).map((star) => {
      const id = `${star}-stars`;
  ...
  return (
    <form className="reviews__form form" action="#" method="post" onSubmit={onFormSubmit}>
      ...
      <div className="reviews__button-wrapper">
        ...
        <button className="reviews__submit form__submit button" type="submit" disabled={isDisabledSubmit ? true : undefined}>Submit</button>
      </div>
    </form>
  );
};
